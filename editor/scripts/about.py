    ...
    def __init__(self, master=None):
        ...
        if os.name == 'nt':
            self.my_image = ctk.CTkImage(light_image=Image.open("main/assets/logo/logo.png"),
                                        ...
                                        size=(400, 200))
            self.welcome_title_text = ctk.CTkLabel(self, text="",image= self.my_image,
        ...
        self.button1 = ctk.CTkButton(self, text="NyxText - Discussions",font=('JetBrainsMono NF',13),fg_color='transparent',text_color='#91d7e3')
        self.button1.pack(side='top', padx=30, pady=(30,5))

        self.button2 = ctk.CTkButton(self, text="Report an Issue",font=('JetBrainsMono NF',13),fg_color='transparent',text_color='#ed8796')
        self.button2.pack(side='top', padx=30, pady=5)

        self.button3 = ctk.CTkButton(self, text="Github Repository", font=('JetBrainsMono NF',13),fg_color='transparent',command=self.open_website,text_color='#a6da95')
        self.button3.pack(side='top', padx=30, pady=5)

        # Add a label named "Social"
        self.social_label = ctk.CTkLabel(self, text="Socials", font=("JetBrainsMono NF", 20, "bold"))
