...
class WelcomeScreen:
    def __init__(self, tab_view):
        ...
        if os.name == "nt":  # for windows
            ...
            welcome_title_desc = customtkinter.CTkLabel(
                self.welcome_tab,
        ...
        welcome_title_start = customtkinter.CTkLabel(
            self.welcome_tab,
            text="Start",
        ...
        welcome_new_button = customtkinter.CTkButton(
            self.welcome_tab,
            text=" New file... ",
            command=lambda: new_window(self.welcome_tab),
        ...
        welcome_open_button = customtkinter.CTkButton(
            self.welcome_tab,
            text=" Open file... ",
            command=lambda: open_window(self.welcome_tab),
            fg_color="transparent",
            hover=False,
            anchor="center",
            text_color="#a6da95",
        ...
        welcome_openfolder_button = customtkinter.CTkButton(
            self.welcome_tab,
            text=" Open Folder... ",
            command=lambda: openfol_window(self.welcome_tab),
            fg_color="transparent",
            hover=False,
            anchor="center",
            text_color="#91d7e3",
        ...
        welcome_about_button = customtkinter.CTkButton(
            self.welcome_tab,
            text=" About... ",
            fg_color="transparent",
            hover=False,
            anchor="center",
            text_color="#8aadf4",
            command=lambda: about_window(self.welcome_tab),
        )
        welcome_about_button.pack()

        welcome_title_recents = customtkinter.CTkLabel(
            self.welcome_tab,
            text="Recents",
            font=("JetBrainsMono NF", 16, "bold"),
            padx=100,
        ...
        welcome_recent = customtkinter.CTkButton(
            self.welcome_tab,
            text=" Github/Parazeeknova/Nyxtext ",
            fg_color="transparent",
            hover=False,
            anchor="center",
            text_color="#ee99a0",
