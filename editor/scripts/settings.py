...
class Settings:
    def __init__(self, master):
        ...
        font_option_menu.place(
            x=200, y=20
        )  # Position the option menu to the right of the label
        ...
        font_size_option_menu = ctk.CTkComboBox(
            self.settings_window,
            values=font_sizes,
            variable=selected_font_size,
            command=on_font_size_select,
        )
        font_size_option_menu.place(
            x=200, y=70
        )  # Position the option menu to the right of the font size label

        # Create a label for the font color settings
        font_color_label = ctk.CTkLabel(self.settings_window, text="Font Color")
        font_color_label.place(
            x=20, y=120
        )  # Position the label below the font size label
        ...
        def on_font_color_select():
            ...
            if color_code[
                1
            ]:  # Check if a color was selected (color_code[1] is not None)
        ...
        font_color_button = ctk.CTkButton(
            self.settings_window, text="Choose Color", command=on_font_color_select
        )
        font_color_button.place(
            x=200, y=120
        )  # Position the button to the right of the font color label

        # Create a label for the system theme settings
        system_theme_label = ctk.CTkLabel(self.settings_window, text="System Theme")
        system_theme_label.place(
            x=20, y=170
        )  # Position the label below the font color label
        ...
        system_theme_option_menu = ctk.CTkOptionMenu(
            self.settings_window,
            values=system_themes,
            variable=selected_system_theme,
            command=on_system_theme_select,
        )
        system_theme_option_menu.place(
            x=200, y=170
        )  # Position the option menu to the right of the system theme label

        # Create a label for the color scheme settings
        color_scheme_label = ctk.CTkLabel(self.settings_window, text="Color Scheme")
        color_scheme_label.place(
            x=20, y=220
        )  # Position the label below the system theme label
        ...
        color_scheme_option_menu = ctk.CTkOptionMenu(
            self.settings_window,
            values=color_schemes,
            variable=selected_color_scheme,
            command=on_color_scheme_select,
        )
        color_scheme_option_menu.place(
            x=200, y=220
        )  # Position the option menu to the right of the color scheme label
        ...
        codespace_color_scheme_label = ctk.CTkLabel(
            self.settings_window, text="CodeSpace Color Scheme"
        )
        codespace_color_scheme_label.place(
            x=20, y=270
        )  # Position the label below the color scheme option menu

        # Create the option menu with CodeSpace color scheme options
        codespace_color_scheme_option_menu = ctk.CTkOptionMenu(
            self.settings_window,
            values=color_schemes1,
            variable=selected_color_scheme1,
            command=on_color_scheme_select,
        )
        codespace_color_scheme_option_menu.place(
            x=200, y=270
        )  # Position the option menu to the right of the CodeSpace color scheme label
